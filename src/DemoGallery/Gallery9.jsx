...
import pic_2 from '../Gimages/img2.jpg'
import pic_3 from '../Gimages/img3.jpg'
import pic_4 from '../Gimages/img4.jpg'
import pic_5 from '../Gimages/img5.jpg'
import pic_6 from '../Gimages/img7.jpg'
                ...
                <SRLWrapper>
                    <div className=''>
                        <div className="container-fluid mt-32 mb-4">
                            <h1 className='uppercase text-6xl font-bold text-amber-500 text-center mb-10' style={{ fontFamily: 'Lobster' }}>CYCLOLOGY PLOGGING</h1>
                            <div className="row">
